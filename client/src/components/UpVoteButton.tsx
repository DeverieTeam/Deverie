    ...
    if (data && auth && auth.role !== "client") {
      ...
      switch (voteStatus) {
        case "upvote":
          return (
            <div
              className="px-1 mr-3 md:mr-0 w-14 h-6 md:h-8 bg-green-500 self-end md:self-center gap-1 hover:text-white justify-center text-center rounded-full shadow-sm shadow-green-700 flex"
            ...
            >
              ...
              <p className="my-auto">{data.up_votes}</p>
            </div>
          );
        case "downvote":
          return (
            <div
              className="px-1 mr-3 md:mr-0 w-14 h-6 md:h-8 bg-green-100 self-end md:self-center gap-1 hover:text-white justify-center text-center rounded-full shadow-sm shadow-green-700 flex"
        ...
        case "novote":
          return (
            <div
              className="px-1 mr-3 md:mr-0 w-14 h-6 md:h-8 bg-green-300 self-end md:self-center gap-1 hover:text-white justify-center text-center rounded-full shadow-sm shadow-green-700 flex"
